...
SAMPLES_PER_PACKET = 115  # 16-bit samples per BLE packet
...
def decodeFn(data: bytes) -> dict[str, np.ndarray]:
    ...
    Packet format:
        - Byte 0: Header (0xAA)
        - Byte 1: Packet counter (0-255)
        - Bytes 2-232: Audio data (115 samples × 2 bytes + 1 padding)
        - Byte 233: Trailer (0x55)
    """
    # Validate packet
    ...
    # Extract audio samples (bytes 2 to 232, 231 bytes = 115 samples + 1 padding)
